...
<div class="row">
	<div class="col-lg-5">
        ...
        @endif
		 ...
		 <form method="POST" action="{{URL::to('payrollReports/payRemittances')}}" accept-charset="UTF-8">
    ...
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                        <label for="username">Select Payment Mode:</label>
                        ...
                        <div class="checkbox">
                        <label>
                            <input type="checkbox" checked name="selM">
                              Select All Mode
                        </label>
                    </div>
