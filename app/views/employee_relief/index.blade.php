        ...
        <tr>
          ...
          <td>
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="{{URL::to('employee_relief/view/'.$rel->id)}}">View</a></li>

                    <li><a href="{{URL::to('employee_relief/edit/'.$rel->id)}}">Update</a></li>
                   
                    <li><a href="{{URL::to('employee_relief/delete/'.$rel->id)}}" onclick="return (confirm('Are you sure you want to delete this employee`s relief?'))">Delete</a></li>
